...
def update_screen(question, c_1, c_2):
    print()
...
def game(name):
    ...
    intro = "Welcome, " +name+ "! \nThis is a game of choices; you decide your fate. Let's test your decision skills"
    intro += ("\nEvery choice you make will lead you down a different path and impact your future. \nLet's see how long you can survive... (;")
    gui.start(intro)
    gui.root.mainloop()
    ...
    if jump==("y"):
        ...
        ice_cream = input("Now they invite you to go get ice cream, do you go with them? [y/n] ")
        if ice_cream==("y"):
...
#Survival adventure, find items, use them?
#Zombies, crackeads, whatver???
